...
Benchmark Heaven 的公开题。数字是第一名是否命中金标。Jev 一列来自 Jev 1.13.0 在同一批题上的公开逐题记录。

Easy 48 题。Hard 111 题在读取上限 4096 下评测，题干和选项都在窗口内。训练时的最大长度仍是 768。Hard 全档 220 题（另有 109 题未公开）上，Jev 1.13.0 的记录是 74.1%。

| 切分 | 题族 | 题数 | 排序头 | Jev 1.13.0 |
|---|---|---:|---:|---:|
| Easy | 合计 | 48 | 47 | 48 |
| Easy | 是否事实 | 12 | 11 | 12 |
| Easy | 抽字段 | 12 | 12 | 12 |
